...
export const FOODS: FoodRecord[] = [
  // Generic / homemade
  f("Cheeseburger", null, ["hamburger", "burger", "beef burger"], 540, 31, 40, 27, 2, 8, 1040, 220, "USDA-style standard"),
  f("Hamburger", null, ["burger"], 450, 25, 36, 21, 2, 6, 750, 200, "USDA-style standard"),
  f("French fries", null, ["fries", "chips"], 365, 4, 48, 17, 4, 0, 250, 117, "USDA medium serving"),
  f("Pizza slice, cheese", null, ["pizza", "cheese pizza"], 285, 12, 36, 10, 2, 4, 640, 107, "USDA 1/8 of 14-inch"),
  f("Pizza slice, pepperoni", null, ["pepperoni pizza"], 313, 13, 35, 13, 2, 4, 760, 111, "USDA 1/8 of 14-inch"),
  f("Chicken burrito", null, ["burrito"], 700, 38, 76, 26, 8, 4, 1580, 380, "Typical restaurant burrito"),
  f("Beef taco", null, ["taco", "tacos"], 210, 9, 21, 10, 3, 1, 350, 100, "USDA hard taco"),
  f("Chicken taco", null, ["taco"], 180, 12, 16, 8, 2, 1, 320, 95, "Typical street taco"),
  f("Chicken bowl", null, ["rice bowl", "burrito bowl"], 620, 42, 68, 18, 10, 4, 1400, 450, "Typical grain bowl"),
  f("Caesar salad with chicken", null, ["caesar salad", "salad"], 470, 32, 18, 30, 3, 3, 980, 300, "Restaurant entree salad"),
  f("Garden salad", null, ["salad", "green salad"], 150, 4, 12, 10, 4, 5, 220, 200, "Side salad with dressing"),
  f("Spaghetti with meat sauce", null, ["spaghetti", "pasta", "spaghetti bolognese"], 580, 24, 78, 16, 6, 12, 920, 400, "Restaurant pasta plate"),
  f("Spaghetti carbonara", null, ["carbonara", "pasta"], 740, 28, 70, 36, 3, 4, 1100, 380, "Restaurant carbonara"),
  f("Lasagna", null, ["lasagna"], 600, 32, 48, 30, 4, 10, 1200, 350, "USDA-style serving"),
  f("Fried chicken", null, ["chicken", "fried chicken", "chicken pieces"], 490, 32, 18, 32, 1, 0, 980, 200, "2 pieces mixed"),
  f("Grilled chicken breast", null, ["chicken breast", "grilled chicken", "chicken", "baked chicken"], 280, 53, 0, 6, 0, 0, 430, 170, "USDA 6 oz cooked"),
  f("Chicken tenders", null, ["chicken strips", "chicken fingers", "tenders", "chicken"], 380, 28, 22, 18, 1, 1, 860, 170, "3–4 tenders"),
  f("Chicken sandwich", null, ["chicken burger", "crispy chicken sandwich"], 520, 28, 44, 24, 2, 6, 1200, 220, "Breaded chicken sandwich"),
  f("Rotisserie chicken", null, ["roast chicken", "quarter chicken", "chicken"], 320, 36, 0, 18, 0, 0, 520, 170, "1/4 chicken, skin on"),
  f("Orange chicken", null, ["sesame chicken", "general tso", "chicken"], 490, 24, 52, 20, 2, 22, 980, 280, "Chinese-American plate without rice"),
  f("Chicken wings", null, ["wings", "buffalo wings", "chicken"], 430, 30, 8, 30, 0, 0, 980, 160, "6 pieces with skin"),
  f("Sushi roll, California", null, ["sushi", "sushi roll", "california roll"], 255, 9, 38, 7, 3, 5, 520, 180, "6–8 pieces"),
  f("Sushi roll, spicy tuna", null, ["sushi", "spicy tuna"], 290, 16, 38, 8, 2, 4, 640, 180, "6–8 pieces"),
  ...
  f("Club sandwich", null, ["sandwich", "club sandwich"], 620, 36, 48, 30, 3, 8, 1400, 280, "Triple-decker"),
  ...
  f("Falafel wrap", null, ["falafel"], 540, 16, 62, 24, 8, 6, 880, 280, "Pita wrap"),
  ...
  f("Chicken curry", null, ["curry"], 560, 32, 42, 28, 6, 8, 980, 400, "With rice"),
  f("Butter chicken", null, ["butter chicken", "curry"], 620, 34, 40, 34, 4, 10, 1100, 400, "With rice"),

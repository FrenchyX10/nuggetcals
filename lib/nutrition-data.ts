...
export const FOODS: FoodRecord[] = [
  ...
  f("Burrito", null, ["burrito", "stuffed burrito"], 900, 40, 90, 32, 10, 4, 1900, 450, "Typical burrito when protein is unknown"),
  f("Chicken burrito", null, ["chicken burrito"], 1050, 48, 96, 38, 11, 4, 2100, 480, "Typical stuffed restaurant burrito"),
  f("Steak burrito", null, ["steak burrito"], 1100, 50, 94, 40, 11, 4, 2200, 500, "Typical stuffed restaurant burrito"),
  f("Beef burrito", null, ["beef burrito"], 1100, 50, 94, 40, 11, 4, 2200, 500, "Typical stuffed restaurant burrito"),
  f("Bean burrito", null, ["bean and cheese burrito", "bean burrito"], 680, 22, 92, 22, 14, 4, 1600, 400, "Bean and cheese burrito"),
  f("Carnitas burrito", null, ["carnitas burrito", "pork burrito"], 1100, 46, 94, 44, 11, 4, 2200, 500, "Pork burrito"),
  f("Breakfast burrito", null, ["egg burrito", "breakfast burrito"], 780, 32, 72, 36, 8, 4, 1700, 400, "Egg breakfast burrito"),
  f("Taco", null, ["taco", "street taco"], 200, 11, 18, 9, 2, 1, 340, 100, "1 taco when protein is unknown"),
  ...
  f("Caesar salad", null, ["caesar salad", "caesar salad no chicken"], 290, 8, 16, 22, 2, 2, 680, 220, "No chicken"),
  f("Caesar salad with chicken", null, ["chicken caesar", "caesar salad with chicken"], 470, 32, 18, 30, 3, 3, 980, 300, "Restaurant entree salad"),
  f("Garden salad", null, ["green salad", "house salad", "side salad", "salad"], 150, 4, 12, 10, 4, 5, 220, 200, "Side salad with dressing"),
  f("Cobb salad", null, ["cobb", "cobb salad"], 580, 36, 16, 40, 4, 4, 1100, 360, "Restaurant cobb"),
  ...
  f("Chicken Burrito", "Chipotle", ["chipotle chicken burrito", "chicken burrito"], 1070, 55, 98, 39.5, 13, 3, 2370, 500, "Chipotle nutrition calculator", "https://www.chipotle.com/nutrition-calculator"),
  f("Steak Burrito", "Chipotle", ["chipotle steak burrito", "steak burrito"], 1060, 52, 97, 40, 13, 3, 2320, 500, "Chipotle nutrition calculator", "https://www.chipotle.com/nutrition-calculator"),
  f("Carnitas Burrito", "Chipotle", ["chipotle carnitas burrito", "carnitas burrito"], 1110, 48, 97, 48, 13, 3, 2310, 500, "Chipotle nutrition calculator", "https://www.chipotle.com/nutrition-calculator"),
  ...
  f("Steak Bowl", "Chipotle", ["chipotle steak bowl", "steak burrito bowl"], 750, 49, 70, 27.5, 12, 3, 1890, 520, "Chipotle nutrition calculator", "https://www.chipotle.com/nutrition-calculator"),
  ...
  f("Chicken Salad", "Chipotle", ["chipotle chicken salad", "chicken salad"], 500, 43, 21, 27, 8, 5, 1460, 400, "Chipotle nutrition calculator", "https://www.chipotle.com/nutrition-calculator"),
  f("Chips and Guacamole", "Chipotle", ["chips and guacamole", "guacamole", "chips and guac"], 770, 10, 77, 48, 14, 2, 680, 230, "Chipotle nutrition calculator", "https://www.chipotle.com/nutrition-calculator"),
  f("Chips and Queso", "Chipotle", ["chips and queso", "queso"], 890, 18, 87, 51, 10, 3, 1290, 250, "Chipotle nutrition calculator", "https://www.chipotle.com/nutrition-calculator"),
  f("Chicken Tacos (3)", "Chipotle", ["chipotle chicken tacos", "chicken tacos"], 780, 48, 63, 32, 9, 3, 1680, 320, "Chipotle nutrition calculator", "https://www.chipotle.com/nutrition-calculator"),
  ...
  f("Cobb Salad", "Chick-fil-A", ["cobb", "cobb salad"], 510, 40, 28, 27, 5, 8, 1360, 351, "Chick-fil-A nutrition", "https://www.chick-fil-a.com/nutrition-allergens"),

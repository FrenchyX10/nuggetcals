...
3. Vision AI identifies every item, then uses visible ingredients as a scale (scoops, piece count, how full the plate is) to pick small, medium, or large. Common foods get a second look so “pizza” becomes pepperoni vs cheese, curry becomes tikka masala vs biryani, Mexican becomes enchiladas vs fajitas, and sushi is split by filling and piece count.
